...
const TermsOfService = () => {
  ...
  return (
    <FullContainer>
      ...
      <TextContainer>
        <Title>1. AGREEMENT TO TERMS</Title>
        <Description>
          <Description>
            These Terms of Use constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity (“you”)
            and Blockwave Labs., doing business
            as contact@blockwavelabs.io ("contact@blockwavelabs.io," “we," “us,"
            or “our”), concerning your access to and use of the https://3tree.io
            website as well as any other media form, media channel, mobile
            website or mobile application related, linked, or otherwise
            connected thereto (collectively, the “Service”). We are registered
            in South Korea and have our registered office at 8F, 8,
            Gangnam-daero 84-gil, Gangnam-gu, Seoul, 06241. You agree that by
            accessing the Service, you have read, understood, and agreed to be
          ...
          <Description>
            ...
            check the applicable Terms every time you use our Service so that
          ...
          <Description>
            The Service is not tailored to comply with industry-specific
            regulations (Health Insurance Portability and Accountability Act
            (HIPAA), Federal Information Security Management Act (FISMA), etc.),
            so if your interactions would be subjected to such laws, you may not
            use this Service. You may not use the Service in a way that would
      ...
      <TextContainer>
        ...
        <Description>
          <Description>
            ...
            Service (collectively, the “Content”) and the trademarks, service
            ...
            Marks are provided on the Service “AS IS” for your information and
            personal use only. Except as expressly provided in these Terms of
            Use, no part of the Service and no Content or Marks may be copied,
          ...
          <Description>
            ...
            Service, the Content and the Marks.
          </Description>
        </Description>
      </TextContainer>
      <TextContainer>
        <Title>3. USER REPRESENTATIONS</Title>
        <Description>
          <Description>
            ...
            the Service; (5) you will not access the Service through automated
            ...
            purpose; and (7) your use of the Service will not violate any
      ...
      <TextContainer>
        <Title>4. USER REGISTRATION</Title>
        <Description>
          You may be required to register with the Service with the service
          through 3rd party applications. You agree that you will be responsible
          ...
          our sole discretion, that such username is inappropriate, obscene, or
          otherwise objectionable.
        </Description>
      </TextContainer>
      <TextContainer>
        <Title>5. PROHIBITED ACTIVITIES</Title>
        <Description>
          <Description>
          ...
          <Description>As a user of the Service, you agree not to:</Description>
          <ol>
            <li>
      ...
      <TextContainer>
        <Title>6. USER GENERATED CONTRIBUTIONS</Title>
        <Description>
          <Description>
            ...
            other users of the Service and through third-party websites. As
      ...
      <TextContainer>
        <Title>7. CONTRIBUTION LICENSE</Title>
        <Description>
        ...
        <Description>
          ...
          in your Contributions provided by you in any area on the Service. You
          are solely responsible for your Contributions to the Service and you
        ...
        <Description>
          ...
          Service; and (3) to pre-screen or delete any Contributions at any time
          and for any reason, without notice. We have no obligation to monitor
          your Contributions.
        </Description>
      </TextContainer>
      <TextContainer>
        <Title>8. GUIDELINES FOR REVIEWS</Title>
        <Description>
          We may provide you areas on the Service to leave reviews or ratings.
      ...
      <TextContainer>
        ...
        <Description>
          ...
          through the Service via your account, including without limitation any
          friend lists; and
        </Description>
        <Description>
        ...
        <Description>
          ...
          Accounts may be available on and through your account on the Service.
        </Description>
        <Description>
          ...
          Content may no longer be available on and through the Service.
        </Description>
        <Description>
          You will have the ability to disable the connection between your
          account on the Service and your Third-Party Accounts at any time.
        </Description>
        <Description>
        ...
        <Description>
          You can deactivate the connection between the Service and your
      ...
      <TextContainer>
        <Title>10. SUBMISSIONS</Title>
        <Description>
          You acknowledge and agree that any questions, comments, suggestions,
          ideas, feedback, or other information regarding the Service
      ...
      <TextContainer>
        <Title>11. THIRD-PARTY WEBSITE AND CONTENT</Title>
        <Description>
          The Service may contain (or you may be sent via the Service) links to
          ...
          Websites accessed through the Service or any Third-Party Content
          posted on, available through, or installed from the Service, including
          ...
          us. If you decide to leave the Service and access the Third-Party
          ...
          install from the Service. Any purchases you make through Third-Party
      ...
      <TextContainer>
        <Title>13. SERVICE MANAGEMENT</Title>
        <Description>
          We reserve the right, but not the obligation, to: (1) monitor the
          Service for violations of these Terms of Use; (2) take appropriate
      ...
      <TextContainer>
        <Title>14. PRIVACY POLICY</Title>
        <Description>
          We care about data privacy and security. Please review our Privacy
          Policy : https://www.3tree.io/privacyPolicy. By using the Service, you
          agree to be bound by our Privacy Policy, which is incorporated into
          these Terms of Use. Please be advised the Service is hosted in South
          Korea. If you access the Service from any other region of the world
          with laws or other requirements governing personal data collection,
          use, or disclosure that differ from applicable laws in South Korea,
          then through your continued use of the Service, you are transferring
          your data to South Korea, and you agree to have your data transferred
          to and processed in South Korea. Further, we do not knowingly accept,
      ...
      <TextContainer>
        <Title>15. COPYRIGHT INFRINGEMENTS</Title>
        <Description>
          We respect the intellectual property rights of others. If you believe
          that any material available on or through the Service infringes upon
          ...
          not sure that material located on or linked to by the Service
          infringes your copyright, you should consider first contacting an
          attorney.
        </Description>
      </TextContainer>{" "}
      <TextContainer>
        <Title>16. TERM AND TERMINATION</Title>
        <Description>
          These Terms of Use shall remain in full force and effect while you use
          the Service. WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS OF
          USE, WE RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT
          NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF THE SERVICE (INCLUDING
          ...
          PARTICIPATION IN THE SERVICE OR DELETE YOUR ACCOUNT AND ANY CONTENT OR
      ...
      <TextContainer>
        <Title>17. MODIFICATIONS AND INTERRUPTIONS</Title>
        <Description>
          We reserve the right to change, modify, or remove the contents of the
          Service at any time or for any reason at our sole discretion without
          notice. However, we have no obligation to update any information on
          our Service. We also reserve the right to modify or discontinue all or
          part of the Service without notice at any time. We will not be liable
        ...
        <Description>
          ...
          your inability to access or use the Service during any downtime or
          discontinuance of the Service. Nothing in these Terms of Use will be
          construed to obligate us to maintain and support the Service or to
          supply any corrections, updates, or releases in connection therewith.
        </Description>
      </TextContainer>{" "}
      <TextContainer>
        <Title>18. GOVERNING LAW</Title>
        <Description>
          These Terms shall be governed by and defined following the laws
          of South Korea. Blockwave Labs. and yourself irrevocably consent that
          the courts of South Korea shall have exclusive jurisdiction to resolve
          any dispute which may arise in connection with these terms.
        </Description>
      </TextContainer>{" "}
      <TextContainer>
        <Title>19. DISPUTE RESOLUTION</Title>
        ...
        <Description>
          ...
          expressly provided below) informally for at least thiry (30) days
        ...
        <Description>
          ...
          be three. The seat, or legal place, of arbitration shall be South
          Korea. The language of the proceedings shall be Korean. The governing
          law of the contract shall be the substantive law of South Korea.
        </Description>
      ...
      <TextContainer>
        <Title>20. CORRECTIONS</Title>
        <Description>
          There may be information on the Service that contains typographical
          errors, inaccuracies, or omissions, including descriptions, pricing,
          availability, and various other information. We reserve the right to
          correct any errors, inaccuracies, or omissions and to change or update
          the information on the Service at any time, without prior notice.
        </Description>
      </TextContainer>{" "}
      <TextContainer>
        <Title>21. DISCLAIMER</Title>
        <Description>
          THE SERVICE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE
          THAT YOUR USE OF THE SERVICE AND OUR SERVICES WILL BE AT YOUR SOLE
          ...
          ANY WEBSITES LINKED TO THE SERVICE AND WE WILL ASSUME NO LIABILITY OR
          ...
          SERVICE, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS
          AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION
          STORED THEREIN, (4) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO
          OR FROM THE SERVICE, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE
          ...
          SERVICE. WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME
          RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A
          THIRD PARTY THROUGH THE SERVICE, ANY HYPERLINKED WEBSITE, OR ANY
      ...
      <TextContainer>
        <Title>22. LIMITATIONS OF LIABILITY</Title>
        <Description>
      ...
      <TextContainer>
        <Title>23. INDEMNIFICATION</Title>
        <Description>
      ...
      <TextContainer>
        <Title>24. USER DATA</Title>
        <Description>
          We will maintain certain data that you transmit to the Service for the
          purpose of managing the performance of the Service, as well as data
          relating to your use of the Service. Although we perform regular
          routine backups of data, you are solely responsible for all data that
          you transmit or that relates to any activity you have undertaken using
          the Service. You agree that we shall have no liability to you for any
      ...
      <TextContainer>
        ...
        <Description>
          ...
          OF TRANSACTIONS INITIATED OR COMPLETED BY US OR VIA THE SERVICE. You
      ...
      <TextContainer>
        <Title>26. MISCELLANEOUS</Title>
        <Description>
          These Terms of Use and any policies or operating rules posted by us on
          the Service or in respect to the Service constitute the entire
          ...
          Use or use of the Service. You agree that these Terms of Use will not
      ...
      <TextContainer>
        ...
        <Description>
          ...
          <br />
          <br />
          <span>Blockwave Labs.</span>
          <br />
          <br />
          <span>8F, 8, Gangnam-daero 84-gil, Gangnam-gu, Seoul, 06241</span>
          <br />
          <br />
